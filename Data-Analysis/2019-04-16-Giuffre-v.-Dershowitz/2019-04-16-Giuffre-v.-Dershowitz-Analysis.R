#### 2019-04-16-Complaint-Giuffre-v.-Dershowitz-Analysis
...
raw_text <- read_file("2019-04-16-Complaint-Giuffre-v.-Dershowitz-C.txt")
...
### Create a Network with brigams with 4 or more appearances
