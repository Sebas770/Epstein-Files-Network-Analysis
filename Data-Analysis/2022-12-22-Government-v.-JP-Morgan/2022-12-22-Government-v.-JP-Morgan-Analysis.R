#### 2022-12-22-Complaint-Government-v.-JP-Morgan-Analysis
...
raw_text <- read_file("2022-12-22-Complaint-Government-v.-JP-Morgan-C.txt")
...
### Create a Network with brigams with 5 or more appearances
