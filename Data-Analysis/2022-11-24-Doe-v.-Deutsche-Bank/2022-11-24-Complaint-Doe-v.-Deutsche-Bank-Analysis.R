#### 2022-11-24-Doe-v.-Deutsche-Bank-Analysis
...
raw_text <- read_file("2022-11-24-Complaint-Doe-v.-Deutsche-Bank-C.txt")
...
### Create a Network with brigams with 12 or more appearances
...
# Plot 1: connected component without Weigth 9
set.seed(9)
plot(
  gcc, 
