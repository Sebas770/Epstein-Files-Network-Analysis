#### 2022-11-24-Complaint-Doe-v.-JP-Morgan-Analysis
...
raw_text <- read_file("2022-11-24-Complaint-Doe-v.-JP-Morgan-C.txt")
...
### Create a Network with brigams with 11 or more appearances
